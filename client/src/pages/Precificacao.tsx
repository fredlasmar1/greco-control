        ...
        <Card className="bg-card border-card-border">
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-center gap-6 mt-2 text-xs text-muted-foreground">
              <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-sm bg-[#01696F]" /><span>Lucro</span></div>
          ...
          return (
            <Card key={item.id} className="bg-card border-card-border" data-testid={`pricing-card-${item.id}`}>
              <CardContent className="p-0">
                ...
                >
                  <Scissors className="w-4 h-4 text-[#01696F] flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      ...
                      {item.itemCount > 0 ? (
                        <span className="text-[10px] text-[#01696F]">{item.itemCount} itens na ficha</span>
                      ) : (
                ...
                {isExpanded && (
                  <div className="border-t border-border/50 p-3 bg-muted/5">
                    ...
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        className="bg-[#01696F] hover:bg-[#0C4E54] text-white h-7 text-xs"
